# Decision: iOS Project Structure
...
## Context
Brand new iOS app for the Printfarmer 3D printer farm platform. Backend already exists at ~/s/PFarm1 with 42+ REST endpoints, SignalR hub, JWT auth.
...
### 5. Networking: Actor-based APIClient
...
### 6. Models: Sendable Codable structs
